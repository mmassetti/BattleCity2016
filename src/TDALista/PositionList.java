...
public interface PositionList<E> extends Iterable<E> {
	 ...
	 * 
	 * @param p
	 *            Posición a obtener su elemento siguiente.
	 * @return Posición del elemento siguiente a la posición pasada por
	 *         parámetro.
	 * @throws InvalidPositionException
	 *             si el posición pasada por parámetro es inválida o la lista
	 *             está vacía.
	 * @throws BoundaryViolationException
	 *             si la posición pasada por parámetro corresponde al último
	 ...
	 * 
	 * @param p
	 *            Posición a obtener su elemento anterior.
	 * @return Posición del elemento anterior a la posición pasada por
	 *         parámetro.
	 * @throws InvalidPositionException
	 *             si la posición pasada por parámetro es inválida o la lista
	 *             está vacía.
	 * @throws BoundaryViolationException
	 *             si la posición pasada por parámetro corresponde al primer
	 *             elemento de la lista.
	 */
	 ...
	 * 
	 * @param element
	 *            Elemento a insertar al principio de la lista.
	 */
	 ...
	 * 
	 * @param p
	 *            Posición en cuya posición siguiente se insertará el elemento
	 *            pasado por parámetro.
	 * @param element
	 *            Elemento a insertar luego de la posición pasada como
	 *            parámetro.
	 * @throws InvalidPositionException
	 ...
	 * 
	 * @param p
	 *            Posición en cuya posición anterior se insertará el elemento
	 *            pasado por parámetro.
	 * @param element
	 *            Elemento a insertar antes de la posición pasada como
	 *            parámetro.
	 * @throws InvalidPositionException
	 *             si la posición es inválida o la lista está vacía.
	 */
	 ...
	 * 
	 * @param p
	 *            Posición a establecer el elemento pasado por parámetro.
	 * @param element
	 *            Elemento a establecer en la posición pasada por parámetro.
